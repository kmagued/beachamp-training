...
function AdminPaymentsContent() {
  ...
  async function fetchPayments() {
    const { data } = await supabase
      .from("payments")
      .select("*, profiles!payments_player_id_fkey(first_name, last_name, phone), subscriptions!payments_subscription_id_fkey(start_date, end_date, package_id, packages(id, name))")
