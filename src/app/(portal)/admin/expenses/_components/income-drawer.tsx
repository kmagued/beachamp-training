...
export function IncomeDrawer({ open, onClose, categories, editingIncome, onSuccess, onCategoriesChange, onSwitchToExpense }: IncomeDrawerProps) {
  ...
  return (
    <Drawer open={open} onClose={onClose} title={editingIncome ? "Edit Income" : "Add Income"}>
      <div className="space-y-4">
        {onSwitchToExpense && !editingIncome && (
          <EntryTypeSwitch value="income" onChange={(v) => v === "expense" && onSwitchToExpense()} />
        )}
