...
/** Expense form body — rendered inside a Drawer by ExpenseDrawer or EntryDrawer */
export function ExpenseForm({ open, onClose, categories, editingExpense, onSuccess, defaultDate, sessions }: ExpenseFormProps) {
...
/** Standalone Add/Edit Expense drawer (used where there is no income counterpart) */
export function ExpenseDrawer(props: ExpenseFormProps) {
  return (
    <Drawer
      open={props.open}
